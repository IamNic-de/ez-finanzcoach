    ...
    <div>
        <form action="index.php?page=credit_request_p_details" method="POST">
            <div class="mar-20">
                ...
                value="20000" class="slider-txt center-txt border-none" />
            </div>
            <div class="mar-20">
                <label for="running_time">Laufzeit</label>
                <input type="range" name="running_time" id="running_time_range" 
                min="6" max="120" step="1">
                <input type="text" name="running_time" id="running_time_txt" value="40" class="slider-txt center-txt border-none" />
            </div>
            <div class="mar-20">
                <label for="monthly_rate">Monatsrate</label>
                <input type="range" name="monthly_rate" id="monthly_rate_range" 
                min="50" max="2500" step="30" />
                <input type="text" name="monthly_rate" id="monthly_rate_txt" value="500" class="slider-txt center-txt border-none" />
            </div>
            <div class="mar-20">
